...
plt.title('Performance diagram for XGBoost', fontdict=font)
...
plt.savefig('F:/H621/0626-performance-XGBoost.png', dpi=1000)

print("Plot saved to F:/H621/0626-performance-XGBoost.png")
